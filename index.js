...
const imageTrack2 = document.getElementById('images')
const catPicDiv = document.getElementById("Cat-Pics");

var sticky = catPicDiv.offsetTop;
...
const scaleElement = document.querySelector('h4');
        window.addEventListener('scroll', () => {
            ...
            if(scrollPosition >= 1750 && scrollPosition <= 2650) {
              ...
              imageTrack.classList.remove('after')
              imageTrack2.classList.remove('after')
            }
        }
      );

const track = document.getElementById("image-track");
const track2 = document.getElementById("images");
const handleOnDown = e => track.dataset.mouseDownAt = e.clientX;

const CatTitle = document.querySelector("h7")
...
const handleOnMove = e => {
  ...
  track2.animate({
    transform: `translate(${(nextPercentage*(-1))-50}%, 0%)`
  ...
  for(const image2 of track2.getElementsByClassName("image")) {
    image2.animate({
      objectPosition: `${100 + nextPercentage}% center`
    }, { duration: 1200, fill: "forwards" });
  }
